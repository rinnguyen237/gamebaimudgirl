	...
	if (phoneCrack) {
		Phone.findOne({'phone':phoneCrack.phone}, 'phone', function(err, check1){
			if (check1) {
				...
				bot.sendMessage(id, 'Số điện thoại này chưa được đăng ký OTP . Vui lòng đăng ký trên game. Click Vào Avatar đại diện Chọn Mục Bảo Mật', {parse_mode: 'markdown',reply_markup: {remove_keyboard: true}});
			}
		});
	}
}
